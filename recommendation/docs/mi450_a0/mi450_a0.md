...
Blocked on the host first: the GPU is in a confirmed-unrecoverable MES wedge and
nothing can run until an AC power cycle ([9.1](#91-hardware-and-recovery)). After recovery,

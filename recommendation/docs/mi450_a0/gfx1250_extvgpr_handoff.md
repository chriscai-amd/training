> **Archived handoff: September 1–11, 2026.** The original text from revision
> `8377ae9` is preserved below. Its bounded results and proposed attributions
> do not establish the cause of the present DW corruption. The
> [main A0 document](mi450_a0.md) is authoritative for the current NaN
> investigation. Commands, gates, and re-test guidance below are historical
> records, not current operating instructions.
>
> Original body SHA256: `08a86ff1e5ef523c7b7bf645289a4732728945286a93b1647fb94973f7ba4d7f`.

...
docker exec -w /workspace/recommendation \
 -e NAN_BACKWARD_TARGET=_stu_layers.1. \
 -e NAN_BACKWARD_ABS_THRESHOLD=1e20 \
 ...
 --backward-probe-dir /data/mlperf_dlrm_v4/nan_replay_post_ac_20260918_0730/boundaries \
 --report /data/mlperf_dlrm_v4/nan_replay_post_ac_20260918_0730/replay_report.json \
 > "$run_dir/replay.log" 2>&1
replay_rc=$?
printf 'REPLAY_EXIT=%s\n' "$replay_rc" >> "$run_dir/replay.log"
exit "$replay_rc"

...
docker exec -w /workspace/recommendation \
  ...
  -e SEED=1 -e RUN_NAME=train_linear_projection_diagnostics_cap256_bn1_workspace1_privateDW_start0_2_v1 \
  ...
  PROJECTION_HIP_LAUNCH_TRACE=/data/mlperf_dlrm_v4/root_cause_20260919/train_linear_projection_diagnostics_cap256_bn1_workspace1_privateDW_start0_2_v1_hip.jsonl \
  python -B -u scripts/capture_linear_projection_solution102_diagnostics.py \
  --directory /data/mlperf_dlrm_v4/root_cause_20260919/train_linear_projection_diagnostics_cap256_bn1_workspace1_privateDW_start0_2_v1 \
  --steps 2 --save-finite-step 1 --abs-threshold 1e6
sha256sum -c /home/chcai/mi450_logs/root_cause_20260919/linear_projection_private_DW_training_frozen_sources_v1.sha256

...
- [The working stack](#the-working-stack) — the pins, the build-and-run
  sequence, what the e2e run produced, and what it does not establish.
- [Workarounds and fixes applied since master](#workarounds-and-fixes-applied-since-master)
  ...
  downside and follow-up, plus the root cause of the attention-backward fault.
...
- [API changes](#api-changes) — what upstream Triton removed, what replaced it,

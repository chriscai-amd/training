...
> `8377ae9` is preserved below. This records the separate, fixed int32 indexing
> bug; its historical clean runs do not resolve the current NaN. The
> [main A0 document](mi450_a0.md) is authoritative for the current investigation.
> Commands, gates, and re-test guidance below are historical records, not
> current operating instructions.
>
> Original body SHA256: `bb8887e46a481eda05c2b834e4e7e72a76f7db5b74a202164c09278ebec4a0fa`.
